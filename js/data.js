...
const level3Challenges = [
  ...
  { "id": "N3_D3", "unidade": 3, "tipo": "clique_rapido", "pergunta": "Olhe o retângulo 4x2. Digite apenas o valor das bordas (PERÍMETRO)!", "target": 12, "timeLimit": 15, "cols": 6, "rows": 4, "prePaintedCoords": [[1, 1], [1, 2], [1, 3], [1, 4], [2, 1], [2, 2], [2, 3], [2, 4]], "dica": "Conte apenas o contorno neon amarelo." },
  ...
  { "id": "N3_D15", "unidade": 3, "tipo": "quiz_duas_figuras", "pergunta": "O 'L' e o 'Retângulo'. Ambos usam 4 blocos. O perímetro é igual?", "figA": { "w": 2, "h": 2, "label": "Quadrado 2x2" }, "figB": { "w": 4, "h": 1, "label": "Linha 4x1" }, "targetAnswer": "Não, o 4x1 é maior", "inputType": "options", "inputOptions": ["Sim, são iguais", "Não, o 4x1 é maior"], "dica": "Conte as bordinhas externas de cada um." },
  ...
  { "id": "N3_D23", "unidade": 3, "tipo": "conversao_area", "pergunta": "Uma peça de mosaico vale 5cm². Se o desenho usa 10 peças, qual a área?", "targetAnswer": 50, "inputType": "number", "cols": 6, "rows": 4, "prePaintedCoords": [[1, 1], [1, 2], [1, 3], [1, 4], [1, 5], [2, 1], [2, 2], [2, 3], [2, 4], [2, 5]], "elementos_visuais": { "referencia": { "label": "1 peça = 5cm²" } }, "dica": "10 peças x 5cm² cada." },
  ...
  { "id": "N3_D25", "unidade": 3, "tipo": "conversao_area", "pergunta": "Cada quadrado no mapa vale 2km². O lago ocupa 8 quadrados. Qual a área do lago?", "targetAnswer": 16, "inputType": "number", "cols": 5, "rows": 5, "prePaintedCoords": [[1, 1], [1, 2], [1, 3], [2, 1], [2, 2], [2, 3], [3, 1], [3, 2]], "dica": "8 quadrados x 2km²." },
  ...
  { "id": "N3_D27", "unidade": 3, "tipo": "conversao_area", "pergunta": "O tapete tem 4 quadrados. Se cada um vale 0,5m², qual a área total?", "targetAnswer": 2, "inputType": "number", "cols": 4, "rows": 4, "prePaintedCoords": [[1, 1], [1, 2], [2, 1], [2, 2]], "elementos_visuais": { "referencia": { "label": "1q = 0,5m²" } }, "dica": "0,5 + 0,5 + 0,5 + 0,5 ou 4 x 0,5." },
  ...
  { "id": "N3_D38", "unidade": 3, "tipo": "construcao_livre", "pergunta": "Desenhe qualquer linha de 5 blocos. Qual o seu perímetro?", "targetArea": 5, "targetAnswer": 12, "targetW": 5, "targetH": 1, "inputType": "number", "cols": 6, "rows": 4, "dica": "Para uma linha de 5, o perímetro é sempre 12." },
  ...
  { "id": "N3_D40", "unidade": 3, "tipo": "quiz_multiplo", "pergunta": "Para medir a tela de um cinema, usamos:", "targetAnswer": "m²", "inputType": "options", "inputOptions": ["cm²", "m²", "km²"] }
];
